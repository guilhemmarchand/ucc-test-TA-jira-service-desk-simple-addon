...
logger = log.Logs().get_logger('ta-jira-service-desk-simple-addon_rh_oauth2_token')
...
class ta-jira-service-desk-simple-addon_rh_oauth2_token(admin.MConfigHandler):
    ...
    def getProxyDetails(self):
        ...
        ), "TA-jira-service-desk-simple-addon", realm="__REST_CREDENTIAL__#TA-jira-service-desk-simple-addon#configs/conf-ta-jira-service-desk-simple-addon_settings")
        # Get Conf object of apps settings
        conf = cfm.get_conf('ta-jira-service-desk-simple-addon_settings')
...
if __name__ == "__main__":
    admin.init(ta-jira-service-desk-simple-addon_rh_oauth2_token, admin.CONTEXT_APP_AND_USER)